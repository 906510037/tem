...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run temperature scan evaluation.")
    ...
    parser.add_argument("--output", default="outputs/csv/accuracy_vs_temp.csv")
...
def main() -> None:
    ...
    frame = run_temperature_scan(
        ...
        loader=test_loader,
        device=device,
        ideal_hooks=ideal_hooks,
        original_hooks=original_hooks,
        improved_hooks=improved_hooks,
        temperatures=base_config["eval"]["temperature_points"],
